...
\usepackage[scaled=0.95]{helvet} % Helvetica for any sans-serif needs
...
\usepackage[colorlinks=true, linkcolor=black, citecolor=black,
            urlcolor=[rgb]{0,0.35,0.55}]{hyperref}
\usepackage{parskip}
\usepackage{titlesec}
\usepackage{titling}
...
% ---- Section heading style: small-caps with a subtle rule ----
\titleformat{\section}
  {\large\scshape\bfseries}{}{0em}{}[\vspace{-0.5ex}\rule{\textwidth}{0.4pt}]
...
% ---- Title block styling ----
\pretitle{\begin{center}\LARGE\itshape}
...
\begin{center}
\small
\textit{``There is no royal road to Geometry.''} \quad --- Euclid
\end{center}
...
alone verbally. What might this kind of reaction teach us about Latin and
AI?
...
English vocabulary is derived from Latin \autocite{Culpeper2005}. This is
...
\autocite{Sharwood1993}. Topics such as colors, feelings, and weather allow
