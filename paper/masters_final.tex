...
\title{\textit{Latin Explorer}: Technology, Artificial Intelligence,\\and the Living Latin Classroom}
\author{}
\date{}
...
\begin{quote}
\textit{There is no royal road to Geometry.} --- Euclid
\end{quote}

\bigskip

\noindent Live site: \url{https://lamkalm.github.io/latin-explorer/}\\
GitHub repo: \url{https://github.com/lamkalm/latin-explorer}
